 ...
 *
 * Never alter a field directly throw a function of the child class. Do it with the function {@link ood.database.Table#alterRecord(DatabaseRecord, java.util.Map)}.
 * Moreover, the constructor of the child class must be protected with no parameter (if this constraint is not respected, an exception will be generated). So it is not possible to instantiate directly this class. To do that, you must use the function {@link ood.database.Table#addRecord(java.util.Map)}, or the function {@link ood.database.Table#addRecords(java.util.Map...)}. 
 * 
