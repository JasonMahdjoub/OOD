 ...
 * It is not generated when two threads access to the database. Typically, this exception occurs in some cases when the user call a database function into the classes {@link ood.database.AlterRecordFilter} and {@link ood.database.Filter}.
