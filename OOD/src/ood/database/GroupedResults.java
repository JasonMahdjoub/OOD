 ...
 * 
 * To get an instance of this class, call the functions {@link ood.database.Table#getGroupedResults(String...)} or {@link ood.database.Table#getGroupedResults(Collection, String...)}.
 * 
...
public final class GroupedResults<T extends DatabaseRecord>
{
    ...
    /**
     * This class represent a group (according a set of table fields) of records. It is relative to the use of the class {@link ood.database.GroupedResults}.
