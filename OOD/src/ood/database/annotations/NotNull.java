...
/**
 * This annotation must be declared before a field contained into a class which inherits the class {@link ood.database.DatabaseRecord}. The use of this annotation means that the correspondent field cannot have a null value.
