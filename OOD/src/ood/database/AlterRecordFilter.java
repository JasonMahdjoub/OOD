 ...
 * This filter must be used with the function {@link ood.database.Table#alterRecords(AlterRecordFilter)}.
...
public abstract class AlterRecordFilter<T extends DatabaseRecord>
{
     ...
     *  
     * @param fields a map containing the fields to alter with the given record. Note that primary keys, and unique keys cannot be altered with this filter. To do that, please use the function {@link ood.database.Table#alterRecord(DatabaseRecord, Map)}. 
     */
