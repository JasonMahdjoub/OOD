...
public abstract class FieldAccessor
{
	...
	else
	{
	    start_value=-1;
	    bits_number=-1;
	    limit=_field.getAnnotation(ood.database.annotations.Field.class).limit();
	}
    }
	...
	try
	{
	    ...
	    {
		if (f.isAnnotationPresent(ood.database.annotations.Field.class) || f.isAnnotationPresent(PrimaryKey.class) || f.isAnnotationPresent(ForeignKey.class) || f.isAnnotationPresent(AutoPrimaryKey.class) || f.isAnnotationPresent(RandomPrimaryKey.class))
		{
