...
{
    public static final Version OOD;
    static
    {
	...
	c2.set(2016, 1, 1);
	OOD=new Version("Object Oriented Database", 1, 2, 0, Version.Type.Stable, 0, c1.getTime(), c2.getTime());
	
	InputStream is=Version.class.getResourceAsStream("build.txt");
	...
	if (is!=null)
	{
		...
		OOD.setBuildNumber(Integer.parseInt(b.readLine()));
		b.close();
		isr.close();
		is.close();
	    }
	...
	OOD.addCreator(new Person("mahdjoub", "jason"));
	Calendar c=Calendar.getInstance();
	c.set(2013, 3, 1);
	OOD.addDeveloper(new PersonDeveloper("mahdjoub", "jason", c.getTime()));
