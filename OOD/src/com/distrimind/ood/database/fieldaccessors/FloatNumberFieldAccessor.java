...
public class FloatNumberFieldAccessor extends FieldAccessor
{
    ...
    protected FloatNumberFieldAccessor(Field _field) throws DatabaseException
    {
	super(null, _field);
	...
	try
	{
	    Object val=_result_set.getObject(sql_fields[0].field);
	...
	try
	{
	    Float val=(Float)field.get(_class_instance);
	    Double res=null;
	    if (val!=null)
