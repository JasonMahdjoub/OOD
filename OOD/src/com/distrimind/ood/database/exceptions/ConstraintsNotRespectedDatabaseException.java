 ...
 * For example, if you delete a record through the function {@link com.distrimind.ood.database.Table#removeRecord(com.distrimind.ood.database.DatabaseRecord)}, and if this record is pointed by another record through its foreign key, this exception will be generated. Note that in this example, the problem does not occur with the function {@link com.distrimind.ood.database.Table#removeRecordWithCascade(com.distrimind.ood.database.DatabaseRecord)}.
